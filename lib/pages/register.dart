...
class register extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                obscureText: false,
                decoration: decoration.copyWith(hintText: "Entre your UserName",)),
                SizedBox(
                  height: 33,
                ),
                ...
                ElevatedButton(
                   ...
                   child: Text("Rigester", style: TextStyle(fontSize: 19),),
                ),
    ...
    MaterialPageRoute(builder: (context) => const login()),
                   ...
                   child:  Text('  Sign in', style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18)),)
                  ],
                )
